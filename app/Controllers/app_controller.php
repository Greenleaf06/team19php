...
class App_controller extends Controller
{
    ...
    {
        parent::__construct();
        if ($f3->get('SESSION.nickname') == ''  && ($f3->get('PATTERN')=='/')) {
            $f3->reroute('/signin');
            }
        else if ($f3->get('SESSION.nickname') != ''  && ($f3->get('PATTERN')=='/'))  {
            $f3->reroute('/menu');
        } 
        
      
          if ($f3->get('SESSION.nickname') != ''  && ($f3->get('PATTERN')=='/signin')) {
            $f3->reroute('/menu');
        }
          if ($f3->get('SESSION.nickname') == ''  && ($f3->get('PATTERN')=='/main')) {
          $f3->reroute('/menu');
        }
